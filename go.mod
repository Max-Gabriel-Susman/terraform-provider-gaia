module github.com/Max-Gabriel-Susman/terraform-provider-ouroboros
...
require (
	...
	github.com/hashicorp/terraform-provider-scaffolding v0.0.0-20220203171225-d2932f8baa17
)
